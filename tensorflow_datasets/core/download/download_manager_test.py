...
def _set_checksums(checksums):
  checksums_management._ALL_SIZE_CHECKSUMS.clear()
  checksums_management._ALL_SIZE_CHECKSUMS.update(checksums)
...
class DownloadManagerTest(testing.TestCase):
  ...
  def setUp(self):
    ...
    absltest.mock.patch.object(
        checksums_management, 'maybe_store_checksums').start()
